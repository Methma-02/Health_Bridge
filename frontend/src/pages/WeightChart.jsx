...
//   const height = window.innerWidth > 768 ? 800 : width * 0.6; // Maintain aspect ratio
//   const margin = { top: 20, right: 30, bottom: 50, left: 55 };
//   const chartWidth = width - margin.left - margin.right;
//   const chartHeight = height - margin.top - margin.bottom;
...
//       <h1 className="text-2xl md:text-3xl font-bold text-gradient bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 mb-6 text-center bg-clip-text text-transparent">Weight Gain Chart</h1>
//       <div className="space-y-4">
//         <div className="flex items-center space-x-4 p-4">
//           <div className="flex space-x-4">
//             <div className="flex items-center space-x-2">
...
const WeightGainChart = () => {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto p-4 bg-gradient-to-br from-white to-blue-50 shadow-lg rounded-lg">
      <h1 className={`text-2xl md:text-3xl font-bold text-gradient bg-gradient-to-r ${gender === 'girl' ? 'from-pink-600 via-purple-600 to-red-500' : 'from-blue-600 via-purple-600 to-pink-600'} mb-6 text-center bg-clip-text text-transparent`}>Weight Gain Chart</h1>
