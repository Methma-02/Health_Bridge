...
//                         )
//                     }
//                     className="w-full p-2 text-sm border rounded focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
//                 />
//             ));
//         }
...
//                     value={care[fieldName]}
//                     onChange={(e) => handleBabyCareChange(fieldName, e.target.value)}
//                     className="w-full p-2 text-sm border border-teal-200 rounded focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent bg-teal-50"
//                 />
//             </td>
//         ));
//     };
...
//             <div className="bg-white border-l-4 border-teal-500 p-4 rounded-lg mb-6 shadow">
...
//                                 <td className="p-3">
//                                     <div className="p-3 bg-gradient-to-br from-teal-50 to-teal-100 rounded-lg shadow-sm">
//                                         <div className="font-medium text-teal-700 mb-2">APGAR Score</div>
//                                         {["1M", "2M", "3M"].map((minute) => (
//                                             <div key={minute} className="flex items-center mb-2">
//                                                 <label className="w-8 text-sm text-teal-600">{minute}</label>
//                                                 <input
//                                                     type="number"
//                                                     value={formData.babyCare[0].apga[minute]}
//                                                     onChange={(e) => handleApgarChange(0, minute, e.target.value)}
//                                                     className="w-16 p-1 text-sm border border-teal-300 rounded focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent bg-white"
//                                                 />
//                                             </div>
//                                         ))}
//                                     </div>
//                                 </td>
//                                 <td className="p-3">
//                                     <div className="p-3 bg-gradient-to-br from-teal-50 to-teal-100 rounded-lg shadow-sm h-full">
//                                         <div className="font-medium text-teal-700 mb-2">Birth weight (kg)</div>
//                                         {createBabyCareRow('birthWeight')}
//                                     </div>
//                                 </td>
//                                 <td className="p-3">
//                                     <div className="p-3 bg-gradient-to-br from-teal-50 to-teal-100 rounded-lg shadow-sm h-full">
//                                         <div className="font-medium text-teal-700 mb-2">Head circumference (cm)</div>
//                                         {createBabyCareRow('headCircumference')}
//                                     </div>
//                                 </td>
//                                 <td className="p-3">
//                                     <div className="p-3 bg-gradient-to-br from-teal-50 to-teal-100 rounded-lg shadow-sm h-full">
//                                         <div className="font-medium text-teal-700 mb-2">Height at birth (cm)</div>
//                                         {createBabyCareRow('birthHeight')}
//                                     </div>
//                                 </td>
//                             </tr>
...
//             <div className="bg-white border-l-4 border-amber-500 p-4 rounded-lg mb-6 shadow">
...
//                         <tbody>
//                             {Object.keys(formData.specialNeeds[0]).map((field) => (
//                                 <tr key={field} className="border-b border-amber-100 hover:bg-amber-50">
//                                     <td className="p-3 text-sm font-medium text-amber-700 whitespace-nowrap w-1/3">
//                                         {field.replace(/([A-Z])/g, " $1").charAt(0).toUpperCase() + field.replace(/([A-Z])/g, " $1").slice(1).trim()}
//                                     </td>
...
//                                             value={formData.specialNeeds[0][field].date}
//                                             onChange={(e) => handleSpecialNeedsDateChange(field, e.target.value)}
//                                             className="w-full p-2 text-sm border border-amber-200 rounded focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent bg-amber-50"
...
//             <div className="bg-white border-l-4 border-purple-500 p-4 rounded-lg mb-6 shadow">
//                 <h2 className="text-xl font-semibold text-purple-700 mb-4 flex items-center">
//                     <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
//                         <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
//                     </svg>
//                     Newborn Baby's Health Record
//                 </h2>
//                 <div className="overflow-x-auto">
//                     <table className="w-full border-collapse">
//                         <thead>
//                             <tr className="bg-gradient-to-r from-purple-100 to-purple-200">
//                                 <th className="p-3 text-left text-sm font-semibold text-purple-700"></th>
//                                 <th colSpan={2} className="p-3 text-center text-sm font-semibold text-purple-700">Birth to 10 days</th>
//                                 <th className="p-3 text-center text-sm font-semibold text-purple-700">11 to 28 days</th>
//                                 <th className="p-3 text-center text-sm font-semibold text-purple-700">To 42 days</th>
//                             </tr>
//                             <tr>
//                                 <th className="p-3"></th>
//                                 {[...Array(4)].map((_, i) => (
...
//                                         <input 
//                                             type="date" 
//                                             className="w-full p-2 text-sm border border-purple-200 rounded focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent bg-purple-50"
//                                         />
//                                     </th>
//                                 ))}
//                             </tr>
...
//                                 <tr key={field} className="border-b border-purple-100 hover:bg-purple-50">
...
//             {/* Clinic Days Section */}
//             <div className="bg-white border-l-4 border-green-500 p-4 rounded-lg mb-6 shadow">
...
//                                             <input 
//                                                 type="date" 
//                                                 className="w-full p-2 text-sm border border-green-200 rounded focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent bg-green-50"
//                                             />
//                                         </td>
//                                     ))}
//                                 </tr>
...
//                 <button 
//                     onClick={() => FormSubmitHandler(formattedData)}
