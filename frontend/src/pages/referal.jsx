        ...
        <table className="w-full border-collapse bg-white">
          <thead>
            <tr className="bg-blue-50">
              ...
              <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider border-b w-16">
                Action
              </th>
            </tr>
          </thead>
              ...
              <tr key={item.id} className="hover:bg-gray-50 transition-colors duration-150">
                <td className="px-4 py-2">
                  <input
                    ...
                    className="w-full px-3 py-1.5 text-sm text-gray-700 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200"
                  />
                </td>
                <td className="px-4 py-2">
                  <input
                    ...
                    className="w-full px-3 py-1.5 text-sm text-gray-700 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 placeholder-gray-400 transition-colors duration-200"
                  />
                </td>
                <td className="px-4 py-2">
                  <input
                ...
                <td className="px-4 py-2 text-center">
                  <button
                    ...
                    className="p-1.5 text-red-500 hover:bg-red-50 rounded-md transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
