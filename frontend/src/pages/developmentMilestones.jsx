...
//             <h1 className="text-2xl md:text-3xl font-bold text-gradient bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 mb-6 text-center bg-clip-text text-transparent">Development Milestones Tracker</h1>
//             <div className="overflow-x-auto bg-white rounded-lg shadow-md">
//                 <table className="w-full border-collapse">
//                     <thead>
//                         <tr className="bg-gradient-to-r from-blue-100 to-blue-200">
//                             <th className="p-4 text-left text-sm font-semibold text-blue-700">Age</th>
//                             <th className="p-4 text-left text-sm font-semibold text-blue-700">Milestones</th>
//                             <th className="p-4 text-left text-sm font-semibold text-blue-700">Month</th>
//                             <th className="p-4 text-left text-sm font-semibold text-blue-700">Month Proved</th>
//                             <th className="p-4 text-left text-sm font-semibold text-blue-700">Officer's Designation</th>
//                         </tr>
//                     </thead>
//                     <tbody>
//                         {formData.table.map((ageGroup, ageIndex) => (
...
//                                     {milestoneIndex === 0 && (
//                                         <td rowSpan={ageGroup.milestones.length} className="p-4 text-sm font-medium text-blue-700 bg-blue-50">
//                                             {ageGroup.age}
//                                         </td>
//                                     )}
//                                     <td className="p-4 text-sm text-blue-700">{milestone}</td>
//                                     <td className="p-4">
//                                         <input 
//                                             type="month"  
//                                             value={ageGroup.inputs[milestoneIndex].month}
