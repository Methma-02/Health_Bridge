...
// // //                 setFormData(data); // Replace the entire formData with fetched data
// // //             } else if (data) {
// // //                 // Handle case where API returns data in a different format
// // //                 setFormData(prevFormData => ({
// // //                     ...prevFormData,
// // //                     regNo: data.regNo || prevFormData.regNo,
// // //                     // If data.table doesn't exist, keep the previous table
// // //                     table: data.table && Array.isArray(data.table) ? data.table : prevFormData.table
// // //                 }));
// // //             }
...
// //                 }));
// //             } else if (data) {
// //                 // If table doesn't exist, keep the existing table structure but update regNo
// //                 setFormData(prevFormData => ({
// //                     ...prevFormData,
// //                     regNo: data.regNo || prevFormData.regNo
// //                 }));
